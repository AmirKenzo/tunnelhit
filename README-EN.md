...
```
bash <(curl -s https://raw.githubusercontent.com/AmirKenzo/tunnelhit/refs/heads/main/install_utunnel.sh --ipv4)
```

🤖 Telegram Monitoring Bot Installation
```
bash <(curl -s https://raw.githubusercontent.com/AmirKenzo/tunnelhit/refs/heads/main/MonitorBotinstall.sh --ipv4)
```
